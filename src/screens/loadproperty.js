...
class loadproperty extends React.Component {
    ...
    deleteData(id) {
        ...
        var url = "https://api.mlab.com/api/1/databases/test-db/collections/buildings/" + id + "?apiKey=7qVBz8U57eN2ZvobziWxyhxq1UpqiLnO";
